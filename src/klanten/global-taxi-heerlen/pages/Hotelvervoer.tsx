...
const service = config.services.find((s) => s.id === 'hotelvervoer')!;

export const Hotelvervoer = () => {
      ...
      <section className="py-16 text-white" style={{ backgroundColor: dk }}>
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest mb-3">
            ...
            <span className="text-gray-400">Hotelvervoer</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h2 className="text-2xl font-extrabold mb-4" style={{ color: dk }}>
                Professioneel vervoer voor hotelgasten
              </h2>
              <p className="text-gray-600 leading-relaxed mb-5">{service.description}</p>
              <p className="text-gray-600 leading-relaxed mb-8">
                Wij werken samen met hotels in Heerlen en omgeving om gasten een vlekkeloze aankomst en vertrek te bieden. Onze netjes geklede chauffeurs staan op tijd klaar en zorgen voor een professionele, discrete service.
              </p>

              <div
                className="rounded-2xl p-6 mb-8"
                style={{ backgroundColor: ac + '15', border: `1px solid ${ac}50` }}
              >
                <h3 className="font-extrabold mb-3" style={{ color: dk }}>Ideaal voor hotels</h3>
                <p className="text-sm text-gray-600 leading-relaxed">
                  Bent u hoteleigenaar of -manager en zoekt u een betrouwbare taxipartner voor uw gasten? Neem contact met ons op voor een samenwerking op maat.
                </p>
              </div>
            ...
            <div>
              ...
              >
                <h3 className="font-extrabold text-lg mb-2" style={{ color: dk }}>Boek hotelvervoer</h3>
                <p className="text-sm text-gray-600 mb-5">
                  Bel ons 24/7 voor reserveringen.
                </p>
                <a
