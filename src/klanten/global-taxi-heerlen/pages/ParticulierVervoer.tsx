...
const service = config.services.find((s) => s.id === 'particulier-vervoer')!;
      ...
      <section className="py-16 text-white" style={{ backgroundColor: dk }}>
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest mb-3">
            ...
            <span className="text-gray-400">Particulier vervoer</span>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h2 className="text-2xl font-extrabold mb-4" style={{ color: dk }}>Uw persoonlijke chauffeur</h2>
              <p className="text-gray-600 leading-relaxed mb-5">{service.description}</p>
              <p className="text-gray-600 leading-relaxed mb-8">
                Of u nu naar een verjaardag gaat, een medische afspraak heeft of gewoon comfortabel wilt reizen — Global Taxi Heerlen staat voor u klaar. Onze vriendelijke chauffeurs helpen u van deur tot deur en zorgen voor een ontspannen rit.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                {[
                  { icon: '🏥', title: 'Ziekenhuisvervoer', desc: 'Voor medische afspraken en behandelingen.' },
                  { icon: '🎉', title: 'Evenementen', desc: 'Feestjes, bruiloften en andere gelegenheden.' },
                  { icon: '🛍️', title: 'Dagjes uit', desc: 'Winkelen, uitjes of andere bestemmingen.' },
                  { icon: '🌙', title: 'Nachtritten', desc: '24/7 beschikbaar, ook in de nacht.' },
                ].map((item, i) => (
            ...
            <div>
              ...
              >
                <h3 className="font-extrabold text-lg mb-2" style={{ color: dk }}>Direct boeken</h3>
                <p className="text-sm text-gray-600 mb-5">
                  Bel ons 24/7 voor een rit.
                </p>
                <a
