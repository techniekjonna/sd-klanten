      ...
      <section className="relative py-24 text-white text-center" style={{ backgroundColor: config.colors.text }}>
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-300 max-w-xl mx-auto">
            Heeft u een vraag of wilt u een rit boeken? Wij zijn 24/7 bereikbaar.
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {[
                ...
                <div key={label} className="flex gap-4">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center text-xl flex-shrink-0" style={{ backgroundColor: config.colors.primaryLight }}>
                    {icon}
                  </div>
                  <div>
                    <p className="text-sm text-gray-400">{label}</p>
                    {href ? (
                      <a href={href} className="font-medium hover:underline" style={{ color: p }}>{value}</a>
                    ) : (
              ...
              <div className="flex gap-4 pt-2">
                ...
                <div>
                  ...
                  <p className="font-medium" style={{ color: config.colors.text }}>Dagelijks: {config.contact.hours.weekday}</p>
                  <p className="text-sm text-gray-500 mt-1">Wij zijn 24 uur per dag, 7 dagen per week bereikbaar voor taxi en takelservice.</p>
                </div>
              </div>

              {/* Emergency call */}
              <div className="mt-6 p-4 rounded-xl border-2 text-center" style={{ borderColor: config.colors.amber, backgroundColor: '#FFFBEB' }}>
                <p className="text-xs font-bold uppercase tracking-wide text-amber-700 mb-2">Spoed? Bel direct</p>
                <a href={`tel:${config.contact.phone}`} className="text-xl font-extrabold" style={{ color: config.colors.amber }}>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Hoe kunnen wij u helpen? (rit aanvragen, takelservice, offerte...)"
                    />
                  </div>
                  <button
                    type="submit"
