...
export const TaxiService = () => {
  const s = config.services.taxi;
  return (
    <Layout>
      <section className="py-24 text-white text-center" style={{ backgroundColor: LIGHT }}>
        <div className="container mx-auto px-4">
          <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: ACCENT }}>Lokaal vervoer</p>
      ...
      <section className="py-20" style={{ backgroundColor: PRIMARY }}>
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="rounded-2xl p-10 text-center" style={{ backgroundColor: CARD, border: `1px solid ${BORDER}` }}>
            <h2 className="text-2xl font-bold text-white mb-4">Rit aanvragen?</h2>
            <p className="text-sm mb-8" style={{ color: MUTED }}>Bel ons direct of vraag een rit aan via het bestelformulier.</p>
